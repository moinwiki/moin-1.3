...
'''Je slot is verlopen. Houd rekening met bewerkingsconflicten!''',
'''Edit "%(pagename)s"''':
'''Bewerk "%(pagename)s"''',
...
'''Toon het vraagteken voor links naar nietbestaande pagina\'s''',
'''Show page trail''':
'''Toon paginaspoor''',
'''Show icon toolbar''':
'''Toon de balk met iconen''',
'''Show top/bottom links in headings''':
'''Toon links naar begin/einde in koppen''',
'''Show fancy diffs''':
...
'''Je bent geabonneerd op deze pagina.</b>''',
...
'''Je hebt geen toestemming voor het plaatsen van bijlagen bij deze pagina.''',
'''New Attachment''':
'''Nieuwe bijlage''',
...
'''Je hebt geen toestemming bijlages van deze pagina op te vragen.''',
'''You are not allowed to view attachments of this page.''':
'''Je hebt geen toestemming bijlagen van deze pagina te bekijken.''',
'''Unsupported upload action: %s''':
'''Opsturen niet ondersteund: %s</b>''',
...
'''Je hebt geen toestemming deze pagina te verwijderen.''',
...
'''Geen spelfouten gevonden!</b>''',
'''You can\'t check spelling on a page you can\'t read.''':
'''Je kunt geen spelling controleren op een pagina die je niet kunt lezen.''',
...
'''Je moet een grafiektype opgeven!''',
'''Bad chart type "%s"!''':
...
'''Verwijderingen worden zo gemarkeerd.''',
'''Additions are marked like this.''':
'''Toevoegingen worden zo gemarkeerd.''',
