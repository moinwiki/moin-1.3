...
Uradite sledeće: koristite dugme "Nazad" u vašem Brauzeru da bi ste se vratili u  Editor i tako ubacili promene u klipbord.
...
'''Rezervna kopija vaših promena je na, [%(backup_url)s stranici].''',
...
'''Drugi korisnici će biti \'\'upozoreni\'\' do %(bumptime)s da vi obrađujete ovu stranicu.''',
'''Use the Preview button to extend the locking period.''':
'''Koristite dugme Pregled da biste tako produžili vreme blokade.''',
'''This page is currently \'\'locked\'\' for editing by %(owner)s until %(timestamp)s, i.e. for %(mins_valid)d minute(s).''':
'''Ova stranica je trenutno \'\'blokirana\'\' radi obrade, od %(owner)s do %(timestamp)s, tačnije još %(mins_valid)d minuta.''',
'''This page was opened for editing or last previewed at %(timestamp)s by %(owner)s.[[BR]]
\'\'\'You should \'\'refrain from editing\'\' this page for at least another %(mins_valid)d minute(s),
to avoid editing conflicts.\'\'\'[[BR]]
To leave the editor, press the Cancel button.''':
'''Ova stranica je poslednji put radi obrađivanja u %(timestamp)s od %(owner)s otvorena.
...
'''Nema napuštenih stranica u ovom vikiju.''',
