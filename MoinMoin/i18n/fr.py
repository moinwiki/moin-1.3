...
'''En appuyant sur \'\'\'%(save_button_text)s\'\'\', vous placez vos modifications sous la %(license_link)s.
...
'''[%(sitename)s] Mise à jour %(trivial)sde « %(pagename)s »''',
'''Trivial ''':
'''mineure ''',
...
'''Plain title index''':
'''Index des titres en texte brut''',
'''XML title index''':
'''Index des titres en format XML''',
'''Python Version''':
'''Version de Python''',
'''MoinMoin Version''':
'''Version de MoinMoin''',
...
'''Macros d\'extension globales''',
'''Local extension macros''':
'''Macros d\'extension locales''',
...
'''Pour vous référer aux pièces jointes d\'une page, utilisez \'\'\'{{{attachment:filename}}}\'\'\', 
...
'''Aucun contenu trouvé. Supprimez les caractères non ASCII du nom du fichier et réessayez.''',
...
'''dernière édition le %(time)s par %(editor)s''',
