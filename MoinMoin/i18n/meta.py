...
'fr': ('Français', 'iso-8859-1', 0, 'Vincent Bernat <bernat@free.fr>',),
...
'nb': ('Norsk Bokmål', 'iso-8859-1', 0, 'Jörg Cassens <jmt@cassens.org>',),
'nl': ('Nederlands', 'iso-8859-1', 0, 'Peter Kleiweg <kleiweg@let.rug.nl>',),
'pt': ('Português', 'iso-8859-1', 0, 'Jorge Godoy <godoy@ieee.org>',),
